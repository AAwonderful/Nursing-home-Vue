<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{path:'/hlWorkAdd'}">新增</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="search">
            <el-form :model="ruleForm" :rules="rules" ref="ruleForm" label-width="100px" class="demo-ruleForm">
                ...
                <el-form-item label="办理人" prop="custName" label-width="100px">
                    <el-select v-model="ruleForm.custName" placeholder="--请选择办理人--">
                        <el-option
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getcus(){
                let url =`http://localhost:8081/checkin/list`
                axios.get(url).then(res=>{
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {//验证成功
                        let url =`http://localhost:8081/hlservice/add`
