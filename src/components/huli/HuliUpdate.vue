<template>
    <div>
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{path:'/huliUpdate'}">更新</el-breadcrumb-item>
        </el-breadcrumb>
        <div class="search">
...
<script>
    ...
    export default {
        ...
        methods: {
            ...
            getData(){
                let url =`http://localhost:8081/huli/get/${this.ruleForm.id}`
                axios.get(url).then(res=>{
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {//验证成功
                        let url =`http://localhost:8081/huli/update`
