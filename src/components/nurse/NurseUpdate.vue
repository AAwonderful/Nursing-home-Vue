<template>
    <div>
        ...
        <el-breadcrumb separator-class="el-icon-arrow-right">
            ...
            <el-breadcrumb-item :to="{path:'/nurseUpdate'}">编辑</el-breadcrumb-item>
        </el-breadcrumb>
...
<script>
    ...
    export default {
        ...
        methods: {
            getData(){
                let url =`http://localhost:8081/nurse/get/${this.ruleForm.id}`
            ...
            submitForm(formName) {
                this.$refs[formName].validate((valid) => {
                    if (valid) {//验证成功
                        let url =`http://localhost:8081/nurse/update`
